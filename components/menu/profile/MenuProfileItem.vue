...
<template>
	<li
		class="pl-4 pr-2 lg:hover:bg-primary border-b-[1px] border-b-[#C2D1D9] lg:border-none mb-4 lg:mb-0"
	>
		<NuxtLink
		...
		>
			...
			/>
			<nuxt-icon v-else name="profileIcon" class="text-[20px]" />
			<span
				v-if="!isLargeScreen && !profileStore.profileData.pending"
			...
			<span
				class="text-sm font-telegraf leading-[18px] underline lg:no-underline lg:text-black lg:font-bold text-blue_light"
			>
				Ver mi perfil
			</span>
		</NuxtLink>
