...
const porcentajeCorrectas = props.data.puntaje;
const porcentajeIncorrectas = props.data.porcentajeIncorrecto;
const porcentajeEnBlanco = props.data.porcentajeBlanco;

const offsetIncorrectas = porcentajeCorrectas;
const offsetEnBlanco = porcentajeCorrectas + porcentajeIncorrectas;</script>
    ...
    <div v-if="data" class="relative rounded-3xl overflow-hidden bg-[#edf9f6] shadow-2xl">
        <div class="flex flex-col lg:flex-row">
            <div class="relative lg:w-1/3 p-10 bg-[#daf3ec] flex items-center justify-center">
                ...
                <path
                    class="fill-none stroke-[#F1F5F9] stroke-[4.2]"
                    d="M18 2.0845
                    a 15.9155 15.9155 0 0 1 0 31.831
                    a 15.9155 15.9155 0 0 1 0 -31.831"
                />
                <path
                    class="circle-percentage stroke-[#22C55E]"
                    :stroke-dasharray="`${porcentajeCorrectas} ${100 - porcentajeCorrectas}`"
                ...
                <path
                    ...
                    :stroke-dasharray="`${porcentajeIncorrectas} ${100 - porcentajeIncorrectas}`"
                    :stroke-dashoffset="25 - offsetIncorrectas"
                    d="M18 2.0845
                    a 15.9155 15.9155 0 0 1 0 31.831
                    a 15.9155 15.9155 0 0 1 0 -31.831"
                />
                <path
                    class="circle-percentage stroke-[#CBD5E1]"
                    :stroke-dasharray="`${porcentajeEnBlanco} ${100 - porcentajeEnBlanco}`"
                    :stroke-dashoffset="25 - offsetEnBlanco"
                    d="M18 2.0845
                    a 15.9155 15.9155 0 0 1 0 31.831
                    a 15.9155 15.9155 0 0 1 0 -31.831"
                />
            ...
            <div class="p-10 lg:w-2/3 flex flex-col gap-8">
                ...
                <div class="lg:grid grid-cols-2 gap-6 lg:space-y-0 space-y-3">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-6 h-6 rounded-full bg-[#CBD5E1] aspect-square"></div>
